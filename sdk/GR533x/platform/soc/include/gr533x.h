...
/** @addtogroup Device_Included
  ...
  */
    ...
    #include "gr53xx_b0.h"
    #include "gr53xx_int_b0.h"

    #define GR533X_RAM_ADDRESS             0x20000000
    #define GR533X_FLASH_ADDRESS           0x00200000
    #define GR533X_FLASH_SIZE              0x01000000
    #define GR533X_ALIAS_ADDRESS           0x01000000
#else
    #error "Please select first the target GR533x device used in your application (in gr53xx.h file)"
#endif
